    ...
    >
      ...
      >
        <motion.div
          ...
          style={{
            background:
              'conic-gradient(from 0deg, transparent 0deg, transparent 88deg, rgba(250, 212, 0, 0.45) 100deg, rgba(250, 212, 0, 1) 118deg, rgba(234, 179, 8, 0.9) 132deg, rgba(250, 212, 0, 0.7) 146deg, transparent 158deg, transparent 360deg)',
          }}
          animate={{ rotate: 360 }}
          transition={{
            duration,
      ...
      <div
        className="relative z-[1] min-h-0 overflow-hidden border border-neutral-200 bg-white shadow-sm"
        style={{
          margin: 'var(--bb-beam)',
